...
def otp():
    ...
    if n.method == 'POST' and form.validate_on_submit():

        headers = {'content-type': 'application/json'}
        URL = 'https://service.chanawee.online/getotp'
        ...
        if result != '0':
            ...
            return redirect('https://www.chanawee.online/authen')
        else:
...
def authen():
    ...
    if request.method == 'POST' and form.validate_on_submit(): 
        ...
        headers = {'content-type': 'application/json'}
        URL = 'https://service.chanawee.online/authen'
        ...
        if result == 1:
            ...
            return redirect('https://www.chanawee.online/reg')
        else:
...
def registration():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        headers = {'content-type': 'application/json'}
        URL = 'https://service.chanawee.online/register'
